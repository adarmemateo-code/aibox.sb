      ...
      >
        <div className="flex items-center">
          <img 
            ...
            alt="AIBOX" 
            className="h-[35px] sm:h-[45px] md:h-[100px] lg:h-[120px] xl:h-[180px] md:scale-[1.3] lg:scale-[1.5] w-auto mix-blend-multiply drop-shadow-xl origin-left transition-all" 
          />
        </div>
